...
ns.RegisterPoints(ns.SLAYERSRISE, {
    [28763856] = {quest=89148, loot={238600}, vignette=6804, parent=true}, -- Glimmering Void Pearl
    [30476907] = {quest=89144, loot={238596}, vignette=6860, parent=true}, -- Miner's Guid(e) to Voidstorm
    [34277609] = {quest=89150, loot={238602}, vignette=6802, parent=true}, -- Star Metal Deposit
