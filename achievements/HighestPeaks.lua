...
ns.RegisterPoints(ns.EVERSONGWOODS, {
	...
	achievement=62288,
	loot={ns.rewards.Currency(ns.CURRENCY_SILVERMOONCOURT, 100)},
	loot_shared={{254773, decor=true}}, -- "Eversong Lantern" Painting
})
...
ns.RegisterPoints(ns.ZULAMAN, {
	...
	achievement=62289,
	loot={ns.rewards.Currency(ns.CURRENCY_AMANI, 100)},
	loot_shared={{256925, decor=true}}, -- Amani Spearhunter's Spit
})
...
ns.RegisterPoints(ns.HARANDAR, {
	...
	achievement=62290,
	loot={ns.rewards.Currency(ns.CURRENCY_HARATI, 100)},
	loot_shared={{265792, decor=true}}, -- Fungarian Vine Fence
})
...
ns.RegisterPoints(ns.VOIDSTORM, {
	...
	achievement=62291,
	loot={ns.rewards.Currency(ns.CURRENCY_SINGULARITY, 100)},
	loot_shared={{264656, decor=true}}, -- Void Elf Weapon Rack
})
