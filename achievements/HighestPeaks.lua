...
}, HIGHEST{achievement=62288, loot={ns.rewards.Currency(ns.CURRENCY_SILVERMOONCOURT, 100)}})
...
}, HIGHEST{achievement=62289, loot={ns.rewards.Currency(ns.CURRENCY_AMANI, 100)}})
...
}, HIGHEST{achievement=62290, loot={ns.rewards.Currency(ns.CURRENCY_HARATI, 100)}})
...
}, HIGHEST{achievement=62291, loot={ns.rewards.Currency(ns.CURRENCY_SINGULARITY, 100)}})
